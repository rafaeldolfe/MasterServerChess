...
namespace Sisus
{
	...
	{
		public const float GameObjectTitlebarHeightWithOneButtonRow = 52f;
		...
		/// </summary>
		public static event Action<Object[], Rect, bool> BeforeComponentHeaderGUI;
		...
		public static float GameObjectTitlebarHeight(bool toolbarHasTwoRowsOfButtons)
		{
			if(toolbarHasTwoRowsOfButtons)
			{
				return GameObjectTitlebarHeightWithTwoButtonRows;
			}
