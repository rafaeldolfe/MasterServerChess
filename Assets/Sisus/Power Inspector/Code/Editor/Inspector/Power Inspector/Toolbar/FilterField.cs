...
namespace Sisus
{
	...
	public class FilterField
	{
		...
		public void RestoreCursorPositions()
		{
			...
			{
				Debug.Log("SearchBox - restored CursorPosition=" + savedCursorPosition + " (was: "+ editor.cursorIndex + "), AltCursorPosition=" + savedAltCursorPosition+ " (was: " + editor.altCursorPosition + "), selectIndex=" + savedSelectIndex+ " (was: " + editor.selectIndex + "), hasHorizontalCursorPos=false (was: "+editor.hasHorizontalCursorPos+")");
			}
			#endif
