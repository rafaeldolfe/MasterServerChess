...
namespace Sisus
{
	...
	public abstract class UnityObjectDrawer<TSelf, TTarget> : ParentDrawer<LinkedMemberInfo>, IUnityObjectDrawer, IDebuggable where TSelf : UnityObjectDrawer<TSelf, TTarget> where TTarget : Object
	{
		...
		public override void OnAfterMembersBuilt()
		{
			...
			{
				PrefixLabelWidth = Mathf.Clamp(GetOptimalPrefixLabelWidth(0), MinAutoSizedPrefixLabelWidth, DrawGUI.MaxAutoSizedPrefixLabelWidth);
			}
		}
		...
		{
			float optimalWidth = GetOptimalPrefixLabelWidth(0);
		...
		public override void Dispose()
		{
			...
			inspector = null; //is this a good idea? Or could this lead to null reference exceptions in inherited classes?
		}
