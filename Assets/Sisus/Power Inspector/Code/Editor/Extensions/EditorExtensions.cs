...
namespace Sisus
{
    public static class EditorExtensions
    {
        ...
        private static readonly FieldInfo firstInspectedEditor;
        ...
        static EditorExtensions()
        {
            ...
            firstInspectedEditor = typeof(Editor).GetField("firstInspectedEditor", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
        }
        ...
        internal static void SetIsFirstInspectedEditor([NotNull]this Editor editor, bool value)
        {
            ...
            {
                #if DEV_MODE
				UnityEngine.Debug.LogWarning(editor.GetType().Name + ".SetIsFirstInspectedEditor(" + value+ ") was called but failed to find internal field Editor.firstInspectedEditor.");
				#endif
				return;
            }

            firstInspectedEditor.SetValue(editor, value);
        }
    }
}